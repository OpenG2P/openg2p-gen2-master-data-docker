#!/usr/bin/env python3
"""
Parse a master-data service spec file and emit a shell-sourceable env file plus
the adapters.requirements.txt consumed by the Dockerfiles.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Parse OpenG2P master-data service spec file.")
