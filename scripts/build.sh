...
Examples:
  ./build.sh
  ./build.sh openg2p-gen2-master-data/1.0.txt
  ./build.sh --push openg2p-gen2-master-data/v1.0.0.txt
  ./build.sh --dockerfile openg2p-gen2-master-data/Dockerfile openg2p-gen2-master-data/1.0.txt
...
for SERVICE_FILE in "${SERVICE_FILES[@]}"; do
  ...
  BUILD_ARGS=(
    ...
    --label "org.opencontainers.image.description=OpenG2P Gen2 Master Data service image"
  )
